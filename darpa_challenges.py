...
ALIGNMENT: list[dict] = [
    ...
    {"n": 8, "status": "partial", "engines": [
     ...
     "note": "The whole search stack is non-convex optimization: micromagnetic SA, Hadamard-seeded filter_sa, ILS max-det descent, H2-cell tile SA. Heuristics, not algebraic-geometry systematics."},
